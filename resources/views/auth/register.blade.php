...
<head>
    ...
    <title>Daftar Akun PPDB SD</title>
...
<body>
    <main class="form-registration text-center">
        <div class="card register-card">
            ...
            <p class="text-muted mb-3">Sudah memiliki akun? <a class="text-link" href="{{ route('login') }}">Masuk</a>
            </p>
            <p class="text-muted small mb-0">&copy; {{ date('Y') }} Sekolah Dasar Negeri 30 Bukit Kanduang. Hak Cipta
                Dilindungi.</p>
